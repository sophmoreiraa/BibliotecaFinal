...
namespace BibliotecaFinal.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoriaLivro")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoriaLivro")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
