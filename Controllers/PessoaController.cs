...
namespace BibliotecaFinal.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomePessoa,CPFPessoa,TELPessoa")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomePessoa,CPFPessoa,TELPessoa")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
